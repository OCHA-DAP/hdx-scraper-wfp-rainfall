# Collector for WFP Rainfall Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-wfp-rainfall/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-wfp-rainfall/actions/workflows/run-python-tests.yaml)
...
.hdx_configuration.yaml in your home directory containing your HDX key, e.g.:
 ...
 facade in run.py. The collector reads the key **hdx-scraper-wfp-rainfall** as specified
...
To install and run, execute:
    ...
    pip install .
    python -m hdx.scraper.wfp_rainfall
